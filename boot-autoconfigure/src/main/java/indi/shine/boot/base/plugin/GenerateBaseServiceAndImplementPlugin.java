package indi.shine.boot.base.plugin;
...
public class GenerateBaseServiceAndImplementPlugin extends PluginAdapter {
    ...
    public List<GeneratedJavaFile> contextGenerateAdditionalJavaFiles(IntrospectedTable introspectedTable) {
        ...
        while(true) {
            ...
            restClass.addImportedType("indi.shine.boot.base.model.PageModel");
            restClass.addImportedType("indi.shine.boot.base.model.result.*");
            restClass.addImportedType("indi.shine.boot.base.model.search.*");
            restClass.addImportedType("indi.shine.boot.base.util.*");
            restClass.addImportedType("indi.shine.boot.base.util.JsonUtil");
