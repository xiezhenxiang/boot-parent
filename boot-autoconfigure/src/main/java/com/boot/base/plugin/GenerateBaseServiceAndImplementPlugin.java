...
public class GenerateBaseServiceAndImplementPlugin extends PluginAdapter {
    ...
    public List<GeneratedJavaFile> contextGenerateAdditionalJavaFiles(IntrospectedTable introspectedTable) {
        ...
        while(true) {
            ...
            restClass.addImportedType("com.boot.base.model.result.RestData");
            restClass.addImportedType("com.boot.base.model.result.RestData");
            restClass.addImportedType("com.boot.base.model.result.RestResp");
            restClass.addImportedType("com.boot.base.model.search.*");
            restClass.addImportedType("com.boot.base.util.BeanValidator");
            restClass.addImportedType("com.boot.base.util.JsonUtils");
            restClass.addImportedType("com.google.gson.reflect.TypeToken");
            restClass.addImportedType("java.util.List;");
            restClass.addImportedType("com.boot.base.model.PageModel");
